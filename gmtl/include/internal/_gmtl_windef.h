...
#if !defined(_GMTL_imtl_windef_H_) || defined(_GMTL_INTERNAL_GMTL_WINDEF_H_)
#error Do not #include this internal file directly; use public IMTL headers instead.
#endif /* _GMTL_imtl_windef_H_ */

#ifndef _GMTL_INTERNAL_GMTL_WINDEF_H_
#define _GMTL_INTERNAL_GMTL_WINDEF_H_
...
#    else
#        if defined(_DEBUG)
#            pragma message(__FILE__ "(" __GMTL_STRING(__LINE__) ") : Warning: Recommend using /MD if compiling with TBB_USE_DEBUG==0")
#        endif
#    endif
#endif

#if __GMTL_BUILD && !defined(__GMTL_NO_IMPLICIT_LINKAGE)
...
#endif  // _GMTL_INTERNAL_GMTL_WINDEF_H_
